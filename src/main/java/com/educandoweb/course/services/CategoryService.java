 ...
 * 
 * @Service --> Para essa que essa classe(CategoryService) funcione na CategoryResource ela tem que se registrar no componente do spring precisamos registrar essa annotation;  
 */